...
parallel -j 30 fastq-dump --gzip --split-files -O /mnt/ribolution/user_worktmp/michael.rade/work/2026-Kluesner-FredHutch/project_s51n/data/single_cell/oekelen_et_al/fastq {} ::: $(cat SRA-manifest)
