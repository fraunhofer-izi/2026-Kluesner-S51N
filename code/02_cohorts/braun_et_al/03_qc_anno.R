...
output.file = paste0(manifest$braun$work, "seurat/02_seurat_pre.Rds")
output.file.2 = paste0(manifest$braun$work, "seurat/03_seurat_anno_t.Rds")

se.meta = readRDS(paste0(manifest$braun$work, "seurat/01_seurat_ori.Rds"))
...
ggsave2(
  filename="figures/braun_et_al/qc_pre_processing/stats_tech_per_cell.pdf",
...
se.t = assign_vdj(
  obj = se.t,
  vdj = "vdj_t",
  batch = c(paste0(manifest$braun$work, "cellranger")),
  present.bool = F
)
